...
<section class="steps">
    <div class="container">
        <div class="row item-step pb-70">
            <div class="col-lg-6 col-12 text-center">
                <img src="/assets/images/step1.png" class="cover" alt="">
            </div>
        ...
        <div class="row item-step pb-70">
            ...
            <div class="col-lg-6 col-12 text-center">
                <img src="/assets/images/step2.png" class="cover" alt="">
            </div>

        </div>
        <div class="row item-step">
            <div class="col-lg-6 col-12 text-center">
                <img src="/assets/images/step3.png" class="cover" alt="">
            </div>
            <div class="col-lg-6 col-12 text-left copywriting">
                <p class="story">
                    END GAME
                ...
                <div class="row">
                    <div class="col-lg-6 col-12">
                        <div class="table-pricing paket-gila">
                            ...
                            <p>
                                <a href="/checkout/gila-belajar" class="btn btn-master btn-primary w-100 mt-3">
                                    Take This Plan
                                </a>
                            </p>
                        </div>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="table-pricing paket-biasa">
                            ...
                            <p>
                                <a href="/checkout/baru-mulai" class="btn btn-master btn-secondary w-100 mt-3">
